...
function printRow(scope, type, values) {
  ...
  console.log(
    `| ${scope.padEnd(10)} | ${type.padEnd(5)} | ${String(values.get).padStart(5)} | ${String(set).padStart(5)} | ${String(acquired).padStart(8)} | ${String(pending).padStart(7)} | ${String(confirmed).padStart(9)} |`,
  )
}
...
console.log(
  `Monitoring Valkey at ${host}:${port}. Press Enter to print counts. Type f and press Enter to print counts and FLUSHALL.`,
)
